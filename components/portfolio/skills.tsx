...
const skillsData = [
  ...
  },
  {
    ...
    icon: (
      <img src="/nextjs.png" alt="Next.js" className="w-10 h-10 object-contain" />
    )
  },
  {
    name: "Spring Boot",
    ...
    icon: (
      <img src="/springboot.png" alt="Spring Boot" className="w-10 h-10 object-contain" />
    )
  },
  {
    name: "MySQL",
    ...
    textColor: "text-blue-600",
    icon: (
      <img src="/mysql.png" alt="MySQL" className="w-10 h-10 object-contain" />
    )
  },
  {
    name: "MongoDB",
